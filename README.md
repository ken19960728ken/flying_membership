...
三大航空聯盟（星空聯盟 / 寰宇一家 / 天合聯盟）會員制度知識庫 — 以 [Obsidian](https://obsidian.md) 管理的個人筆記 vault。

整理各聯盟旗下成員航空、熱門航線、會員等級待遇、達成資格，以及「修行」與「高卡匹配」的進階攻略。資料已查證至 **2026-05** 官方來源（全球視角）。
...
2. `git clone` 本 repo
3. Obsidian →「開啟資料夾作為儲存庫」選擇本資料夾

## ⚠️ 資料時效

會員等級對應關係穩定，但各家**達成門檻、status match 活動變動頻繁**，文中數字為查證當下（2026-05）概況，實際以各航空公司官網最新公告為準。

## 📄 授權

個人知識整理，內容彙整自各航空公司官方資料與公開來源（各筆記末附出處）。
